unless defined? Settings
  RailsConfig.load_and_set_settings Rails.root.join("config", "settings.yml").to_s,
...
WebsocketRails.setup do |config|
  ...
  # * Requires Redis
  config.standalone = Settings.websocket.standalone
  config.standalone_port = Settings.websocket.standalone_port
