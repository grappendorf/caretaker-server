  ...
  begin
    ...
    namespace :db do
      ...
      task :sample => :environment do
        ...
        camera1_device = CameraDevice.create! uuid: '3ce1c6e2-1085-431a-8c24-a5cc66466d2e',
        ...
        camera2_device = IpCameraDevice.create! uuid: '976e79c8-a722-49c7-b1b1-2c36093f9c03',
