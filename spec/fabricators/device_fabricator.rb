...
Fabricator :device do
  guid '6ff07437-9ce8-4a53-9add-d700b4b28582'
  name 'Device'
...
Fabricator :switch_device do
  guid '6a27c513-994d-46cb-b9dd-7bbaf97fa504'
  name 'Switch'
...
Fabricator :camera_device do
  guid '3ce1c6e2-1085-431a-8c24-a5cc66466d2e'
  name 'Camera 1'
...
Fabricator :ip_camera_device do
  guid '976e79c8-a722-49c7-b1b1-2c36093f9c03'
  name 'Camera 2'
...
Fabricator :dimmer_device do
  guid '082ea83d-6a39-4b13-8855-1dff06b6d556'
  name 'Dimmer Device'
...
Fabricator :dimmer_rgb_device do
  guid '7157e214-0093-47a4-a511-3180d49bd4f1'
...
Fabricator :easyvr_device do
  guid '009511eb-5534-472f-84fa-15d7ecde3275'
  name 'EasyVR Device'
...
Fabricator :remote_control_device do
  guid '47f0c8f9-d031-4678-9074-4612098a2198'
...
Fabricator :robot_device do
  guid 'caedc4a8-1788-41cd-86c7-d19517beb078'
  name 'Robot Device'
